...
def process_tracks(results, sp, db_conn):
    ...
    for i in range(len(results['items'])):
        ...
        database.insert_track_into_data_base(track_id, album_id, track_name, parsed_date, db_conn )

        database.insert_artist_into_data_base(artist_id, artists_name, db_conn)

        database.insert_album_into_data_base(album_id, album_name, total_tracks, db_conn)
